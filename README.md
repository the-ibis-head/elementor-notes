...
* [Local Setup with Valet, WP-CLI & Astra/Elementor](#local‐setup-with-valet-wp-cli‐astraelementor)
  * [Install prerequisites (macOS)](#install-prerequisites-macos)
  * [Install & Configure Laravel Valet](#install-‐configure-laravel-valet)
  * [Create a New WordPress Site](#create-a-new-wordpress-site)
  * [Create / Reset the Database & Site](#create-‐reset-the-database-site)
  * [Install Astra & Elementor](#install-astra-elementor)
  * [Mailpit for Email Testing](#mailpit-for-email-testing)
* [Free vs Pro Versions](#free-vs-pro-versions)
  * [Elementor Free](#elementor-free)
  * [Elementor Pro](#elementor-pro)
* [Rolling Back Elementor Versions](#rolling-back-elementor-versions)
  * [Roll Back from the Elementor Interface](#roll-back-from-the-elementor-interface)
  * [Roll Back Using WP-CLI](#roll-back-using-wp-cli)
* [Keyboard Shortcuts for Power Users](#keyboard-shortcuts-for-power-users)
* [Adding and Managing Favorite Widgets in Elementor](#adding-and-managing-favorite-widgets-in-elementor)
  * [How to Add Widgets to Favorites](#how-to-add-widgets-to-favorites)
  * [Popular Widgets to Add to Favorites](#popular-widgets-to-add-to-favorites)
  * [Sync Favorites Between Sites?](#sync-favorites-between-sites)
  * [Creating a Simple Custom Elementor Widget](#creating-a-simple-custom-elementor-widget)
* [Setting Global Typography and Styles](#setting-global-typography-and-styles)
  * [Where to Configure Global Typography](#where-to-configure-global-typography)
  * [Using Google Fonts in Elementor](#using-google-fonts-in-elementor)
  * [Load Only What You Use](#load-only-what-you-use)
  * [Enabling Local Google Fonts (GDPR / Privacy)](#enabling-local-google-fonts-gdpr-privacy)
  * [Common Typography Issues & Fixes](#common-typography-issues--fixes)
* [Text Animations & Scroll Effects + GSAP Video Scroll](#text-animations--scroll-effects--gsap-video-scroll)
  * [Typing Effects in Elementor (free or Pro)](#typing-effects-in-elementor-free-or-pro)
  * [Transitions & Entrance Animations](#transitions--entrance-animations)
  * [Scroll Animations for Text](#scroll-animations-for-text)
  * [What is GSAP and How It Works](#what-is-gsap-and-how-it-works)
  * [Implementing a Video Scroll Animation with GSAP in Elementor](#implementing-a-video-scroll-animation-with-gsap-in-elementor)
* [Integrating Google Analytics With Elementor](#integrating-google-analytics-with-elementor)
  * [Why Track With Google Analytics?](#why-track-with-google-analytics)
  * [Using Elementor Pro (Recommended)](#using-elementor-pro-recommended)
  * [Manual GA4 Code Injection (Elementor Free)](#manual-ga4-code-injection-elementor-free)
  * [Tracking Elementor Events in GA4](#tracking-elementor-events-in-ga4)
  * [Tracking Scroll Depth (Elementor pages)](#tracking-scroll-depth-elementor-pages)
  * [Tracking Elementor Ecommerce Conversions (WooCommerce + GA4)](#tracking-elementor-ecommerce-conversions-woocommerce--ga4)
  * [Tracking Button Clicks on Elementor Pages (GA4)](#tracking-button-clicks-on-elementor-pages-ga4)
  * [Tracking Video Plays on Elementor Pages (YouTube/Vimeo)](#tracking-video-plays-on-elementor-pages-youtubevimeo)
* [Integrating Typeform with Elementor](#integrating-typeform-with-elementor)
  * [Generate Your Typeform Embed Code](#generate-your-typeform-embed-code)
  * [Add the Typeform to Elementor (Inline Embed)](#add-the-typeform-to-elementor-inline-embed)
  * [Add a Popup Typeform (Button or Link Trigger)](#add-a-popup-typeform-button-or-link-trigger)
  * [Adjusting Width, Height & Responsiveness](#adjusting-width-height--responsiveness)
  * [Styling Surrounding Elements in Elementor](#styling-surrounding-elements-in-elementor)
  * [Tracking Typeform Conversions with GA4 or GTM](#tracking-typeform-conversions-with-ga4-or-gtm)
  * [Troubleshooting **Form not loading?**](#troubleshooting-form-not-loading)
